              ...
              <div className="bg-gray-50 border border-gray-100 rounded-lg p-2 flex items-center justify-between shadow-sm">
                <div className="flex items-center gap-1.5">
                  ...
                  <div className="flex flex-col">
                    ...
                    {contract.extensionCount && contract.extensionCount > 0 ? (
                      <span className="text-[6px] font-black text-orange-600 uppercase tracking-tighter ml-1">
                        (Gia hạn lần {contract.extensionCount}/2)
                      </span>
                    ) : null}
                  </div>
                </div>
